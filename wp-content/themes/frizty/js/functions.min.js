...
function frizty_logMarginPadding() {
    jQuery('.wpb_column').each(function() {
        if (jQuery(this).hasClass('tm-left-span')) {
            ...
            randomclass = 'frizty-random-class-' + randomclass;
...
jQuery(document).ready(function($) {
    ...
    jQuery('#site-header-menu #site-navigation div.nav-menu > ul > li:has(ul), .tm-mmmenu-override-yes #site-header-menu #site-navigation .mega-menu-wrap > ul > li:has(ul)').append("<span class='righticon'><i class='tm-frizty-icon-angle-down'></i></span>");
    ...
    jQuery('.righticon').on('click', function() {
        if (jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').hasClass('open')) {
            ...
            jQuery('i', jQuery(this)).removeClass('tm-frizty-icon-angle-up').addClass('tm-frizty-icon-angle-down')
        } else {
            jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').addClass('open');
            jQuery('i', jQuery(this)).removeClass('tm-frizty-icon-angle-down').addClass('tm-frizty-icon-angle-up')
        }
        return !1
    });
    frizty_circle_progress_counter();
    jQuery("a[data-gal^='prettyPhoto']").prettyPhoto({
        hook: 'data-gal'
    });
    jQuery(".themetechmount-slider-wrapper > div > div > div:contains('Revolution Slider Error')").css("margin-top", "0");
    jQuery('select').select2();
    frizty_logMarginPadding();
    frizty_logMarginPadding_right();
    ...
    $(".ttmbannercmsblock-style2 .bannercms_content.first .bannertext2, .ttm_bannercms .bannertext .bannertext1 , .ttm_banneroffer .first .bannertext .bannertext2").html(function() {
...
jQuery(window).load(function() {
    ...
    (function() {
        ...
        jQuery('.menu-toggle').on('click.frizty', function() {
...
function additional() {
    if (jQuery(document).width() <= 1200) {
        ...
        jQuery('.myaccount.topbar-link').appendTo('.tm-header-style-infostack:not(.tm-header-style-infostack-three) .tm-header-top-wrapper');
        jQuery('.tm-quick-links').appendTo('.tm-header-style-infostack-two .tm-header-top-wrapper')
    }
    if (jQuery(document).width() <= 991) {
        jQuery('.tm-header-style-infostack-two .verticalmenu-wrapper').appendTo('.tm-header-style-infostack-two #site-header-menu #site-navigation')
    }
    jQuery('.sidebar .widget:not(.widget_shopping_cart) .product_list_widget').not('.slick-initialized').slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        vertical: !0,
        verticalSwiping: !0,
    ...
    jQuery('.hot-products .image-carousel').not('.slick-initialized').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        dots: !1,
        arrows: !1,
    ...
    if (jQuery(window).width() <= 767) {
        jQuery('.service_wrapper').not('.slick-initialized').slick({
            slidesToShow: 2,
            slidesToScroll: 1,
            dots: !1,
            arrows: !1,
    ...
    jQuery('.additional_carousel').not('.slick-initialized').slick({
        vertical: !0,
        verticalSwiping: !0,
        slidesToShow: 5,
        slidesToScroll: 1,
...
function leftCatMenu() {
    "use strict";
    jQuery('#sidebar-left .product-categories,.widget_nav_menu').addClass('treeview-list');
    jQuery("#sidebar-left .product-categories.treeview-list,.widget_nav_menu.treeview-list").treeview({
        animated: "slow",
        collapsed: !0,
        unique: !0
    });
...
function timecounter() {
    ...
    jQuery('.ttmtimer').each(function() {
        ...
        jQuery(this).countdown(countTime, function(event) {
            jQuery(this).html('<div class="clocktime days"><span class="clocktime-number">' + event.strftime('%D') + '</span><span class="clocktime-text">days</span></div><div class="clocktime hour"><span class="clocktime-number">' + event.strftime('%H') + '</span><span class="clocktime-text">hours</span></div><div class="clocktime minute"><span class="clocktime-number">' + event.strftime('%M') + '</span><span class="clocktime-text">mins</span></div><div class="clocktime second"><span class="clocktime-number">' + event.strftime('%S') + '</span><span class="clocktime-text">secs</span></div>')
        })
    });
...
jQuery(window).load(function() {
    "use strict";
    timecounter();
    jQuery('.mainmenu-wrapper .max-mega-menu li.hiden_menu ').hover(function() {
...
function catmenu() {
    if (jQuery(window).width() < 1200) {
        jQuery(document).ready(function() {
            jQuery('.verticalmenu-wrapper #menu-vertical-menu').addClass('treeview-list');
            jQuery(".verticalmenu-wrapper .treeview-list").treeview({
                animated: "slow",
                collapsed: !0,
                unique: !0
            });
            jQuery('.verticalmenu-wrapper .treeview-list a.active').parent().removeClass('expandable');
            jQuery('.verticalmenu-wrapper .treeview-list a.active').parent().addClass('collapsable');
            jQuery('.verticalmenu-wrapper .treeview-list .collapsable ul').css('display', 'block')
        })
    }
}
jQuery(document).ready(function() {
