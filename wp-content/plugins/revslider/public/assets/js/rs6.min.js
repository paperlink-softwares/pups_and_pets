...
! function(e, t) {
    ...
    window.RSANYID = window.RSANYID === t ? [] : window.RSANYID, window.RSANYID_sliderID = window.RSANYID_sliderID === t ? [] : window.RSANYID_sliderID, e.fn.extend({
        ...
        getversion: function() {
            return "Slider Revolution 6.2.20"
        },
        ...
        deepLink: function(a, r) {
            var o;
            if (r !== t && r.length < 9)
                if (r.split("slide").length > 1 && -1 == r.indexOf("slider")) {
                    var s = parseInt(r.split("slide")[1], 0);
                    e.isNumeric(parseInt(s, 0)) && ((s = parseInt(s, 0)) < 1 && (s = 1), s > i[a].slideamount && (s = i[a].slideamount), o = s)
                } else
                    for (var n in i[a].slides) i[a].slides.hasOwnProperty(n) && i.gA(i[a].slides[n], "deeplink") == r && (o = parseInt(n) + 1);
            return o
        },
        ...
        updateDims: function(e, a) {
            ...
            return i[e].heightInLayers = t, i[e].widthInLayers = t, "ignore" !== a && u && (i[e].pr_next_key !== t ? i.animateTheLayers({
        ...
        getFullscreenOffsets: function(a) {
            ...
            return i[a].fullScreenOffset != t && (!e.isNumeric(i[a].fullScreenOffset) && i[a].fullScreenOffset.split("%").length > 1 ? r += i.getWinH(a) * parseInt(i[a].fullScreenOffset, 0) / 100 : e.isNumeric(parseInt(i[a].fullScreenOffset, 0)) && (r += parseInt(i[a].fullScreenOffset, 0) || 0)), i[a].fullScreenOffsetResult = r, r
        },
                    ...
                    if (i[r].slides.hasOwnProperty(c) && "length" !== c) {
                        ...
                        if (i[r].thumbs[l] = e.extend({}, !0, f), d > 0 && tpGS.gsap.set(u, {
                            ...
                            var b = i.gA(u, "link") !== t ? i.gA(u, "link") : "slide",
                                _ = "slide" != b ? "no" : i.gA(u, "linktoslide"),
                                w = i.gA(u, "seoz");
                            if (_ != t && "no" != _ && "next" != _ && "prev" != _)
                                for (var x in i[r].slides) i[r].slides.hasOwnProperty(x) && parseInt(i.gA(i[r].slides[x], "origindex"), 0) + 1 == i.gA(u, "linktoslide") && (_ = i.gA(i[r].slides[x], "key"));
                ...
                if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && !0 !== i[r].overflowHidden && i[r].c.css({
                        ...
                        if (L.hasOwnProperty(T)) {
                            ...
                            if ("true" != I.animationonscroll && 1 != I.animationonscroll || (I.startclasses += " rs-sba", A[0].className += " rs-sba"), I.startclasses.indexOf("rs-layer-static") >= 0 && i.handleStaticLayers && i.handleStaticLayers(A, r), "RS-BGVIDEO" !== A[0].tagName) {
                                ...
                                "row" === I.type || "column" === I.type || "group" === I.type ? (A[0].classList.remove("tp-resizeme"), "column" === I.type && (I.width = "auto", A[0].group = "row", tpGS.gsap.set(A, {
                                    width: "auto"
                                }), I.filteronscroll = !1)) : (H = "display:" + ("inline-block" === A[0].style.display ? "inline-block" : "block") + ";", null !== i.closestNode(A[0], "RS-COLUMN") ? (A[0].group = "column", I.filteronscroll = !1) : null !== i.closestNode(A[0], "RS-GROUP-WRAP") && (A[0].group = "group", I.filteronscroll = !1)), I.wrpcls !== t && (M = M + " " + I.wrpcls), I.wrpid !== t && (j = 'id="' + I.wrpid + '"'), A.wrap("<" + G + " " + j + ' class="rs-parallax-wrap ' + M + '" style="' + P + " " + z + B + H + F + '"><rs-loop-wrap style="' + z + B + H + '"><rs-mask-wrap style="' + z + B + H + '">' + (I.pxundermask ? "<rs-px-mask></rs-px-mask>" : "") + "</rs-mask-wrap></rs-loop-wrap></" + G + ">"), !0 !== I.filteronscroll && "true" != I.filteronscroll || i[r].scrolleffect._L.push(A.parent()), A[0].id = A[0].id === t ? "layer-" + Math.round(999999999 * Math.random()) : A[0].id, i.revCheckIDS(r, A[0]), I.pxundermask ? i[r]._Lshortcuts[A[0].id] = {
                    ...
                    for (var y in "on" === i[r].navigation.mouseScrollNavigation && (W.enable = !0), i[r].slides)
                        if (i[r].slides.hasOwnProperty(y)) {
                            ...
                            }), (W.enable && i[r].inviewport || !W.enable) && "all" == i[r].lazyType && (i.loadImages(E[0], r, y), i.waitForCurrentImages(E[0], r, function() {}))
                        }
                    ...
                    })), ("off" != i[r].parallax.type || i[r].sbtimeline.set || !0 === W.enable) && i.scrollTicker(r), !0 !== W.enable && (i[r].inviewport = !0, i.enterViewPort(r)), i.RS_toInit !== t && (i.RS_toInit[r] = !0)
                }
            }
        },
        m = function(e, a) {
    ...
    var I = function(r) {
            if (i[r] !== t) {
                ...
                if (i[r].firstSlideAvailable === t && (i[r].firstSlideAvailable = !0, window.requestAnimationFrame(function() {
                    ...
                    i[r].rowzones != t && (d = d > i[r].rowzones.length ? i[r].rowzones.length : d), i[r].rowzones != t && i[r].rowzones.length > 0 && i[r].rowzones[d] != t && d >= 0 && d <= i[r].rowzones.length && i[r].rowzones[d].length > 0 && i.updateDims(r), delete i[r].sc_indicator, delete i[r].sc_indicator_dir, i[r].firstLetItFree === t && (i.generalObserver(a), i[r].firstLetItFree = !0)
                }
            }
        },
        C = function(a) {
        ...
        F = function(i) {
            return function(i) {
                ...
                if (e.isNumeric(i.scrolleffect.tilt) || -1 !== i.scrolleffect.tilt.indexOf("%") && (i.scrolleffect.tilt = parseInt(i.scrolleffect.tilt)), i.scrolleffect.tilt = i.scrolleffect.tilt / 100, i.navigation.thumbnails.position = "outer-horizontal" == i.navigation.thumbnails.position ? "bottom" == i.navigation.thumbnails.v_align ? "outer-bottom" : "outer-top" : "outer-vertical" == i.navigation.thumbnails.position ? "left" == i.navigation.thumbnails.h_align ? "outer-left" : "outer-right" : i.navigation.thumbnails.position, i.navigation.tabs.position = "outer-horizontal" == i.navigation.tabs.position ? "bottom" == i.navigation.tabs.v_align ? "outer-bottom" : "outer-top" : "outer-vertical" == i.navigation.tabs.position ? "left" == i.navigation.tabs.h_align ? "outer-left" : "outer-right" : i.navigation.tabs.position, i.sbtimeline.speed = parseInt(i.sbtimeline.speed, 0) / 1e3 || .5, !0 === i.sbtimeline.set && !0 === i.sbtimeline.fixed && "auto" !== i.sliderLayout ? (i.sbtimeline.fixStart = parseInt(i.sbtimeline.fixStart), i.sbtimeline.fixEnd = parseInt(i.sbtimeline.fixEnd)) : i.sbtimeline.fixed = !1, i.progressBar === t || "true" != i.progressBar.disableProgressBar && 1 != i.progressBar.disableProgressBar || (i.progressBar.disableProgressBar = !0), i.startDelay = parseInt(i.startDelay, 0) || 0, i.navigation !== t && i.navigation.arrows != t && i.navigation.arrows.hide_under != t && (i.navigation.arrows.hide_under = parseInt(i.navigation.arrows.hide_under)), i.navigation !== t && i.navigation.bullets != t && i.navigation.bullets.hide_under != t && (i.navigation.bullets.hide_under = parseInt(i.navigation.bullets.hide_under)), i.navigation !== t && i.navigation.thumbnails != t && i.navigation.thumbnails.hide_under != t && (i.navigation.thumbnails.hide_under = parseInt(i.navigation.thumbnails.hide_under)), i.navigation !== t && i.navigation.tabs != t && i.navigation.tabs.hide_under != t && (i.navigation.tabs.hide_under = parseInt(i.navigation.tabs.hide_under)), i.navigation !== t && i.navigation.arrows != t && i.navigation.arrows.hide_over != t && (i.navigation.arrows.hide_over = parseInt(i.navigation.arrows.hide_over)), i.navigation !== t && i.navigation.bullets != t && i.navigation.bullets.hide_over != t && (i.navigation.bullets.hide_over = parseInt(i.navigation.bullets.hide_over)), i.navigation !== t && i.navigation.thumbnails != t && i.navigation.thumbnails.hide_over != t && (i.navigation.thumbnails.hide_over = parseInt(i.navigation.thumbnails.hide_over)), i.navigation !== t && i.navigation.tabs != t && i.navigation.tabs.hide_over != t && (i.navigation.tabs.hide_over = parseInt(i.navigation.tabs.hide_over)), i.lazyloaddata !== t && i.lazyloaddata.length > 0 && i.lazyloaddata.indexOf("-") > 0) {
                    ...
                    for (i.lazyloaddata = r[0], a = 1; a < r.length; a++) i.lazyloaddata += j(r[a])
                }
            ...
            for (var n in o[r].layers[e.skey])
                if (o[r].layers[e.skey].hasOwnProperty(n)) {
                    ...
                    if ("preset" !== e.mode) {
                        ...
                        (1 == o[r].gridEQModule || void 0 !== p._lig && "row" !== p.type && "column" !== p.type && "group" !== p.type) && (M = void 0 !== p._lig ? p._lig.width() : o[r].module.width, G = void 0 !== p._lig ? p._lig.height() : o[r].module.height, g = 0, u = 0), b = "c" === b || "m" === b || "center" === b || "middle" === b ? M / 2 - p.eow / 2 + B : "l" === b || "left" === b ? B : "r" === b || "right" === b ? M - p.eow - B : "off" !== p.rsp_o ? b * o[r].CM.w : b, _ = "m" === _ || "c" === _ || "center" === _ || "middle" === _ ? G / 2 - p.eoh / 2 + z : "t" === _ || "top" == _ ? z : "b" === _ || "bottom" == _ ? G - p.eoh - z : "off" !== p.rsp_o ? _ * o[r].CM.w : _, b = p._slidelink ? 0 : o[r].rtl && -1 == ("" + p.width[o[r].level]).indexOf("%") ? parseInt(b) + p.eow : b, p.calcx = parseInt(b, 0) + g, p.calcy = parseInt(_, 0) + u, "row" !== p.type && "column" !== p.type ? p.OBJUPD.POBJ = {
                            zIndex: p.zindex,
                            top: p.calcy,
                            left: p.calcx,
                            overwrite: "auto"
            ...
            if (("containerResized_2" !== e.caller && "swapSlideProgress_2" !== e.caller || !0 === m.animationRendered) && (m.animationRendered = !0, "preset" !== e.mode || !0 === m.frames.frame_1.timeline.waitoncall || void 0 !== m.scrollBasedOffset)) {
                ...
                for (var T in "start" === e.mode && (void 0 !== m.layerLoop && (m.layerLoop.count = 0), e.frame = void 0 === m.triggeredFrame ? 0 : m.triggeredFrame), "continue" !== e.mode && "trigger" !== e.mode && void 0 !== m.timeline && m.timeline.pause(0), "continue" !== e.mode && "trigger" !== e.mode || void 0 === m.timeline || m.timeline.pause(), m.timeline = tpGS.gsap.timeline({
                    ...
                    if (m.ford.hasOwnProperty(T)) {
                        ...
                        if ("frame_0" !== R && "frame_hover" !== R && "loop" !== R) {
                            ...
                            if ("frame_999" !== R || !1 !== _ || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                                ...
                                if (D.force3D = !0, "block" === B.type && (B.ft[0].background = A.sfx.fxc, B.ft[0].visibility = "visible", B.ft[1].visibility = "visible", C.add(tpGS.gsap.fromTo(B.bmask_in, M / 2, B.ft[0], B.ft[1], 0)), C.add(tpGS.gsap.fromTo(B.bmask_in, M / 2, B.ft[1], B.t, M / 2)), "frame_0" !== R && "frame_1" !== R || (N.opacity = 0)), void 0 !== A.color ? D.color = A.color : void 0 !== m.color && "npc" !== m.color[s] && (D.color = m.color[s]), void 0 !== I && void 0 !== I.color ? N.color = I.color : void 0 !== I && void 0 !== m.color && "npc" !== m.color[s] && (N.color = m.color[s]), void 0 !== A.bgcolor ? A.bgcolor.indexOf("gradient") >= 0 ? D.background = A.bgcolor : D.backgroundColor = A.bgcolor : !0 === m.bgcolinuse && (m.bgcol.indexOf("gradient") >= 0 ? D.background = m.bgcol : D.backgroundColor = m.bgcol), void 0 !== I && (void 0 !== I.bgcolor ? I.bgcolor.indexOf("gradient") >= 0 ? N.background = I.bgcolor : N.backgroundColor = I.bgcolor : !0 === m.bgcolinuse && (m.bgcol.indexOf("gradient") >= 0 ? N.background = m.bgcol : N.backgroundColor = m.bgcol)), void 0 !== m.splitText && !1 !== m.splitText)
                                    for (var W in t)
                                        if (void 0 !== A[t[W]] && !m.quickRendering) {
                                            var E = m.splitText[t[W]],
                                                V = w({
                                                    id: r,
                                                    frame: A,
                                                    source: t[W],
                                                ...
                                                Y = m.frames[R].dosplit ? void 0 === A[t[W]].delay ? .05 : A[t[W]].delay / 100 : 0;
                                            m.color[s] === D.color && "frame_1" === R || (V.color = D.color), void 0 !== N && m.color[s] !== N.color && (Q.color = N.color), void 0 !== Q && Q.color !== D.color && (V.color = D.color);
                                            var X = o.clone(V),
                                                J = m.fff ? o.clone(Q) : void 0,
                                                q = A[t[W]].dir;
                                            delete X.dir, X.data = {
                                                splitted: !0
                                                ...
                                                each: Y,
                                                from: q
                                            }, X.duration = M, void 0 !== J && delete J.dir, m.fff ? C.add(z.fromTo(E, J, X), 0) : C.add(z.to(E, X), 0), G = Math.max(G, E.length * Y)
                                        }
                                if (M += G, void 0 === i && (i = "isometric" === o[r].perspectiveType ? 0 : "local" === o[r].perspectiveType ? void 0 !== D.transformPerspective ? D.transformPerspective : m.fff && void 0 !== N.transfromPerspective ? N.transfromPerspective : o[r].perspective : o[r].perspective), m.knowTransformPerspective = i, m.pxundermask || void 0 !== H && (void 0 !== I && "hidden" === I.mask.overflow || "hidden" === A.mask.overflow)) C.add(tpGS.gsap.to(m.m, .001, {
                                    ...
                                    overflow: "hidden"
                                }), 0), m.btrans && (j && (j.rotationX = m.btrans.rX, j.rotationY = m.btrans.rY, j.rotationZ = m.btrans.rZ, j.opacity = m.btrans.o), H.rotationX = m.btrans.rX, H.rotationY = m.btrans.rY, H.rotationZ = m.btrans.rZ, H.opacity = m.btrans.o), m.fff ? C.add(tpGS.gsap.fromTo([m.m, m.cbgmask], M, o.clone(j), o.clone(H)), .001) : C.add(tpGS.gsap.to([m.m, m.cbgmask], M, o.clone(H)), .001);
                                ...
                                D.force3D = "auto", m.fff ? (D.visibility = "visible", void 0 !== m.cbg && C.fromTo(m.cbg, M, N, D, 0), o[r].BUG_safari_clipPath && (N.clipPath || D.clipPath || m.spike) && (N.z && parseInt(N.z, 10) || (N.z = -1e-4), D.z && parseInt(D.z, 10) || (D.z = 0)), void 0 !== m.cbg && "column" === m.type ? C.fromTo(P, M, n(N), n(D), 0) : C.fromTo(P, M, N, D, 0), C.invalidate()) : ("frame_999" !== m.frame && (D.visibility = "visible"), void 0 !== m.cbg && C.to(m.cbg, M, D, 0), !o[r].BUG_safari_clipPath || !D.clipPath && !m.spike || D.z && parseInt(D.z, 10) || (D.z = 0 - .01 * Math.random()), void 0 !== m.cbg && "column" === m.type ? C.to(P, M, n(D), 0) : C.to(P, M, D, 0)), void 0 !== F && "object" != typeof F && "function" != typeof F && F.indexOf("SFXBounce") >= 0 && C.to(P, M, {
                                    scaleY: .5,
                                    scaleX: 1.3,
                                    ease: D.ease + "-squash",
                                    transformOrigin: "bottom"
                                }, 1e-4);
                                var Z = "trigger" !== e.mode && (!0 !== f && "skiprest" !== f || "rebuild" !== e.mode) || e.frame === R || void 0 === A.timeline.start || !jQuery.isNumeric(A.timeline.start) ? "+=0" === A.timeline.start || void 0 === A.timeline.start ? "+=0.05" : parseInt(A.timeline.start, 0) / 1e3 : "+=" + parseInt(A.timeline.startRelative, 0) / 1e3;
                ...
                if (O || (m.lastRequestedMainFrame = "start" === e.mode ? "frame_1" : "continue" === e.mode ? void 0 === e.frame ? m.currentframe : e.frame : m.lastRequestedMainFrame), void 0 !== e.totime ? m.tSTART = e.totime : void 0 !== h && void 0 === e.frame ? m.tSTART = h : void 0 !== e.frame ? m.tSTART = e.frame : m.tSTART = 0, 0 === m.tSTART && void 0 === m.startedAnimOnce && void 0 === m.leftstage && void 0 === m.startedAnimOnce && !0 === m.hideonfirststart && "preset" === e.mode && (o[r]._L[a[0].id].pVisRequest = 0, m.hideonfirststart = !1), "frame_999" !== m.tSTART && "frame_999" !== m.triggeredFrame || !m.leftstage && void 0 !== m.startedAnimOnce) {
                    if ("true" != m.animationonscroll && 1 != m.animationonscroll ? m.timeline.play(m.tSTART) : m.timeline.time(m.tSTART), jQuery.inArray(m.type, ["group", "row", "column"]) >= 0 && void 0 !== e.frame) {
                        ...
                        var ge = void 0 === e.totime ? void 0 !== m.frames[e.frame].timeline.startAbsolute ? parseInt(m.frames[e.frame].timeline.startAbsolute, 0) / 1e3 : void 0 !== m.frames[e.frame].timeline.start ? jQuery.isNumeric(m.frames[e.frame].timeline.start) ? parseInt(m.frames[e.frame].timeline.start, 0) / 1e3 : 0 : .001 : e.totime;
    ...
    var n = function(e) {
        ...
        z = function(e) {
            ...
            if (-1 === k.indexOf("rs_splitted_")) {
                ...
                if ("IFRAME" == h[0].nodeName && "html" === o.gA(h[0], "layertype") && (u = "slide" == e.basealign ? o[f].module.width : o.iWA(f, b), m = "slide" == e.basealign ? o[f].module.height : o.iHE(f), s.width = !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0 ? !x._isstatic || x._incolumn || x._ingroup ? e.width : u * parseInt(e.width, 0) / 100 : I(e.width, L, "auto", u, "auto"), s.height = !jQuery.isNumeric(e.height) && e.height.indexOf("%") >= 0 ? !x._isstatic || x._incolumn || x._ingroup ? e.height : m * parseInt(e.height, 0) / 100 : I(e.height, L, "auto", u, "auto")), _ = jQuery.extend(!0, _, s), "rekursive" != v) {
                    u = "slide" == e.basealign ? o[f].module.width : o.iWA(f, b), m = "slide" == e.basealign ? o[f].module.height : o.iHE(f);
                    var O = !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0 ? !x._isstatic || x._incolumn || x._ingroup ? e.width : u * parseInt(e.width, 0) / 100 : I(e.width, L, "auto", u, "auto"),
                        A = !jQuery.isNumeric(e.height) && e.height.indexOf("%") >= 0 ? !x._isstatic || x._incolumn || x._ingroup ? e.height : m * parseInt(e.height, 0) / 100 : I(e.height, L, "auto", u, "auto"),
                        z = {
                    ...
                    if (x._incolumn) {
                        ...
                        R.width = "100%", void 0 !== e.display && "inline-block" !== e.display || (w = {
                            width: "100%"
                        }), z.width = !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0 ? "100%" : O, "image" === x.type && tpGS.gsap.set(x.img, {
                            width: z.width
                        })
                    } else !jQuery.isNumeric(e.width) && e.width.indexOf("%") >= 0 && (T.minWidth = "slide" === x.basealign || !0 === x._ingroup ? O : o.iWA(f, b) * o[f].CM.w * parseInt(O) / 100 + "px", R.width = "100%", w.width = "100%");
                    if (!jQuery.isNumeric(e.height) && e.height.indexOf("%") >= 0 && (T.minHeight = "slide" === x.basealign || !0 === x._ingroup ? A : o.iHE(f) * (o[f].currentRowsHeight > o[f].gridheight[o[f].level] ? 1 : o[f].CM.w) * parseInt(A) / 100 + "px", R.height = "100%", w.height = "100%", P = !0), x._isnotext || (z.whiteSpace = e.whiteSpace, z.textAlign = e.textAlign, z.textDecoration = e.textDecoration), "npc" != e.color && void 0 !== e.color && (z.color = e.color), x._ingroup && (x._groupw = z.minWidth, x._grouph = z.minHeight), "row" === x.type && (jQuery.isNumeric(z.minHeight) || z.minHeight.indexOf("px") >= 0) && "0px" !== z.minHeight && 0 !== z.minHeight && "0" !== z.minHeight && "none" !== z.minHeight ? z.height = z.minHeight : "row" === x.type && (z.height = "auto"), x._isstatic && x.elementHovered && (p = h.data("frames")) && p.frame_hover && p.frame_hover.transform)
...
function(e) {
    ...
    jQuery.extend(!0, t, {
        ...
        createNavigation: function(e) {
            ...
            y && _(o, e), b && _(l, e), k && _(m, e), (b || k) && t.updateDims(e), t[e].navigation.createNavigationDone = !0, b && jQuery.extend(!0, l, a(e, "thumb")), k && jQuery.extend(!0, m, a(e, "tab")), t[e].c.bind("revolution.slide.onafterswap revolution.nextslide.waiting", function() {
            ...
            jQuery(".bullet, .bullets, .tp-bullets, .tparrows").addClass("noSwipe"), t[e].navigation.touch = void 0 === t[e].navigation.touch ? {} : t[e].navigation.touch, t[e].navigation.touch.swipe_direction = void 0 === t[e].navigation.touch.swipe_direction ? "horizontal" : t[e].navigation.touch.swipe_direction, jQuery(".rs-nav-element").rsswipe({
                ...
                swipeStatus: function(i, o, s, n, d, c, p) {
                    ...
                    var f = "start" === o ? 0 : r ? p[0].end.x - p[0].start.x : i.pageX - a.screenX,
                        ...
                        O = "vertical" === L ? k.find(w).first().outerHeight(!0) + x.space : k.find(w).first().outerWidth(!0) + x.space,
...
function(e) {
    ...
    var a = function(e, t) {
        ...
        r = function(e) {
            ...
            if (u) {
                var _ = t[r].pr_active_bg.find("rs-sbg");
                void 0 !== _[0] && t[r].mtl.add(tpGS.gsap.set(_, {
                    scale: 1,
                    rotationX: 0,
                    rotationY: 0,
                    rotationZ: 0,
            ...
            var w = a(e.animation.easein, m),
                x = a(e.animation.easeout, m);
            if (w = "default" === w || "d" === w ? d.TR[8] || "power2.inOut" : w || d.TR[8] || "power2.inOut", x = "default" === x || "d" === x ? d.TR[9] || "power2.inOut" : x || d.TR[9] || "power2.inOut", requestAnimationFrame(function() {
            ...
            if (0 == c) {
                ...
                var j = 3 == d.trC ? h / 1300 : h / 1e3,
                    F = h / 1e3,
                    W = 5 == d.trC || 6 == d.trC ? 0 : t[r].module.width,
                    E = 5 == d.trC || 6 == d.trC ? 0 : t[r].module.height,
                    V = 12 == c ? W : 15 == c ? 0 - W : 0,
                    Q = 13 == c ? 5 == d.trC || 6 == d.trC ? 0 : t[r].module.height : 14 == c ? 5 == d.trC || 6 == d.trC ? 0 : 0 - t[r].module.height : 0,
                    Y = 1 == d.trC || 2 == d.trC || 5 == d.trC || 6 == d.trC ? 0 : 1,
                    X = 4 == d.trC || 5 == d.trC ? .6 : 6 == d.trC ? 1.4 : 1,
                    J = 5 == d.trC ? 1.4 : 6 == d.trC ? .6 : 1;
                if (7 != d.trC && 4 != d.trC || (W = 0, E = 0), 8 == d.trC ? (t[r].mtl.add(tpGS.gsap.set(t[r].pr_active_slide, {
                        zIndex: 20
                        ...
                        zIndex: 20
                    }), 0), g && t[r].mtl.add(tpGS.gsap.fromTo(t[r].pr_next_bg, j, {
                        x: V,
                        y: Q,
                        overflow: "hidden",
                        scale: J,
    ...
    jQuery.extend(!0, t, {
        ...
        manageVideoLayer: function(e, a, o) {
            ...
            if (s.audio = void 0 !== s.audio && s.audio, i && s.opom) 0 == e.find("rs-poster").length && e.append('<rs-poster class="noSwipe" style="background-image:url(' + s.poster + ');"></rs-poster>');
                ...
                } else n && 0 == e.find("rs-poster").length && e.append(s.posterMarkup), 0 == e.find("iframe").length && e.find("rs-poster").click(function() {
