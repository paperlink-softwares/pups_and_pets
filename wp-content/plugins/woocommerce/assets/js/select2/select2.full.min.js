...
! function(e) {
    ...
    var e, n, d, s, r, p, h, f, g, m, y, i, o, v, a, a = (t && t.fn && t.fn.select2 && t.fn.select2.amd && (u = t.fn.select2.amd), u && u.requirejs || (u ? n = u : u = {}, f = {}, g = {}, m = {}, y = {}, i = Object.prototype.hasOwnProperty, o = [].slice, v = /\.js$/, p = function(e, t) {
            var n, i, o = c(e),
                s = o[0];
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                e.call(this, t, n), t.on("*", function(e, t) {
                    var n; - 1 !== r.inArray(e, o) && (t = t || {}, n = r.Event("select2:" + e, {
                        params: t
            ...
            return c.Extend(i, e), i.prototype.select = function(n) {
                ...
                for (var s = 0; s < e.length; s++) {
                    ...
                    0 <= u.inArray(l.id, i) ? (r = n.filter(function(e) {
                        return function() {
                            return u(this).val() == e.id
                        }
                    }(l)), a = this.item(r), a = u.extend(!0, {}, l, a), a = this.option(a), r.replaceWith(a)) : (a = this.option(l), l.children && (l = this.convertToOptions(l.children), c.appendMany(a, l)), o.push(a))
                }
                return o
            }, i
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                var o = this.tokenizer(t, this.options, function(e) {
                    ...
                    }).length || ((t = i.option(n)).attr("data-select2-tag", !0), i._removeOldTags(), i.addOptions([t])), t = n, i.trigger("select", {
                        data: t
                    })
                });
        ...
        a = function(u) {
            ...
            function i(e) {
                var t, n = e || window.event,
                    ...
                    l = 0,
                    c = 0;
                if ((e = u.event.fix(n)).type = "mousewheel", "detail" in n && (r = -1 * n.detail), "wheelDelta" in n && (r = n.wheelDelta), "wheelDeltaY" in n && (r = n.wheelDeltaY), "wheelDeltaX" in n && (s = -1 * n.wheelDeltaX), "axis" in n && n.axis === n.HORIZONTAL_AXIS && (s = -1 * r, r = 0), o = 0 === r ? s : r, "deltaY" in n && (o = r = -1 * n.deltaY), "deltaX" in n && (s = n.deltaX, 0 === r && (o = -1 * s)), 0 !== r || 0 !== s) return 1 === n.deltaMode ? (o *= t = u.data(this, "mousewheel-line-height"), r *= t, s *= t) : 2 === n.deltaMode && (o *= t = u.data(this, "mousewheel-page-height"), r *= t, s *= t), a = Math.max(Math.abs(r), Math.abs(s)), (!p || a < p) && m(n, p = a) && (p /= 40), m(n, a) && (o /= 40, s /= 40, r /= 40), o = Math[1 <= o ? "floor" : "ceil"](o / p), s = Math[1 <= s ? "floor" : "ceil"](s / p), r = Math[1 <= r ? "floor" : "ceil"](r / p), f.settings.normalizeOffset && this.getBoundingClientRect && (a = this.getBoundingClientRect(), l = e.clientX - a.left, c = e.clientY - a.top), e.deltaX = s, e.deltaY = r, e.deltaFactor = p, e.offsetX = l, e.offsetY = c, e.deltaMode = 0, i.unshift(e, o, s, r), d && clearTimeout(d), d = setTimeout(g, 200), (u.event.dispatch || u.event.handle).apply(this, i)
            }
