...
! function(d) {
    ...
    d.zoom = function(o, t, e, n) {
        var i, u, a, c, r, l, m, s = d(o),
            f = s.css("position"),
            h = d(t);
        return o.style.position = /(absolute|fixed)/.test(f) ? f : "relative", o.style.overflow = "hidden", e.style.width = e.style.height = "", d(e).addClass("zoomImg").css({
            position: "absolute",
            top: 0,
            left: 0,
            opacity: 0,
            ...
            init: function() {
                u = s.outerWidth(), i = s.outerHeight(), a = t === o ? (c = u, i) : (c = h.outerWidth(), h.outerHeight()), r = (e.width - u) / c, l = (e.height - i) / a, m = h.offset()
            },
            move: function(o) {
